...
### Future Improvements:
  ...
  * in our implementation of kr210 geometric_ik, we can see to generate IK solution, one need to repeatedly (partially) evaluate forward kinematics with current knowledge, this implies the generic solution of inverse kinematics takes the form of intelligently search through a tree structure of possible decisions.
